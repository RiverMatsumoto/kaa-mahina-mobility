...
// TODO add rest of reply bytes
enum
{
    ROBOCLAW_ACK_BYTE = 0xff,
    ROBOCLAW_ACK_BYTES = 1,
    ROBOCLAW_CRC16_BYTES = 2,
    ROBOCLAW_M1FORWARD_REPLY_BYTES = 0,
    ROBOCLAW_M1BACKWARD_REPLY_BYTES = 0,
    ROBOCLAW_SETMINMB_REPLY_BYTES = 0,
    ROBOCLAW_SETMAXMB_REPLY_BYTES = 0,
    ROBOCLAW_M2FORWARD_REPLY_BYTES = 0,
    ROBOCLAW_M2BACKWARD_REPLY_BYTES = 0,
    ROBOCLAW_M17BIT_REPLY_BYTES = 0,
    ROBOCLAW_M27BIT_REPLY_BYTES = 0,
    ROBOCLAW_MIXEDFORWARD_REPLY_BYTES = 0,
    ROBOCLAW_MIXEDBACKWARD_REPLY_BYTES = 0,
    ROBOCLAW_MIXEDRIGHT_REPLY_BYTES = 0,
    ROBOCLAW_MIXEDLEFT_REPLY_BYTES = 0,
    ROBOCLAW_MIXEDFB_REPLY_BYTES = 0,
    ROBOCLAW_MIXEDLR_REPLY_BYTES = 0,
    ROBOCLAW_GETM1ENC_REPLY_BYTES = 7,
    ROBOCLAW_GETM2ENC_REPLY_BYTES = 7,
    ROBOCLAW_GETM1SPEED_REPLY_BYTES = 0,
    ROBOCLAW_GETM2SPEED_REPLY_BYTES = 0,
    ROBOCLAW_RESETENC_REPLY_BYTES = 0,
    ROBOCLAW_GETVERSION_REPLY_BYTES = 0,
    ROBOCLAW_SETM1ENCCOUNT_REPLY_BYTES = 0,
    ROBOCLAW_SETM2ENCCOUNT_REPLY_BYTES = 0,
    ROBOCLAW_GETMBATT_REPLY_BYTES = 4,
    ROBOCLAW_GETLBATT_REPLY_BYTES = 0,
    ROBOCLAW_SETMINLB_REPLY_BYTES = 0,
    ROBOCLAW_SETMAXLB_REPLY_BYTES = 0,
    ROBOCLAW_SETM1PID_REPLY_BYTES = 0,
    ROBOCLAW_SETM2PID_REPLY_BYTES = 0,
    ROBOCLAW_GETM1ISPEED_REPLY_BYTES = 0,
    ROBOCLAW_GETM2ISPEED_REPLY_BYTES = 0,
    ROBOCLAW_M1DUTY_REPLY_BYTES = 0,
    ROBOCLAW_M2DUTY_REPLY_BYTES = 0,
    ROBOCLAW_MIXEDDUTY_REPLY_BYTES = 0,
    ROBOCLAW_M1SPEED_REPLY_BYTES = 0,
    ROBOCLAW_M2SPEED_REPLY_BYTES = 0,
    ROBOCLAW_MIXEDSPEED_REPLY_BYTES = 0,
    ROBOCLAW_M1SPEEDACCEL_REPLY_BYTES = 0,
    ROBOCLAW_M2SPEEDACCEL_REPLY_BYTES = 0,
    ROBOCLAW_MIXEDSPEEDACCEL_REPLY_BYTES = 0,
    ROBOCLAW_M1SPEEDDIST_REPLY_BYTES = 0,
    ROBOCLAW_M2SPEEDDIST_REPLY_BYTES = 0,
    ROBOCLAW_MIXEDSPEEDDIST_REPLY_BYTES = 0,
    ROBOCLAW_M1SPEEDACCELDIST_REPLY_BYTES = 0,
    ROBOCLAW_M2SPEEDACCELDIST_REPLY_BYTES = 0,
    ROBOCLAW_MIXEDSPEEDACCELDIST_REPLY_BYTES = 0,
    ROBOCLAW_GETBUFFERS_REPLY_BYTES = 0,
    ROBOCLAW_GETPWMS_REPLY_BYTES = 0,
    ROBOCLAW_GETCURRENTS_REPLY_BYTES = 6,
    ROBOCLAW_MIXEDSPEED2ACCEL_REPLY_BYTES = 0,
    ROBOCLAW_MIXEDSPEED2ACCELDIST_REPLY_BYTES = 0,
    ROBOCLAW_M1DUTYACCEL_REPLY_BYTES = 0,
    ROBOCLAW_M2DUTYACCEL_REPLY_BYTES = 0,
    ROBOCLAW_MIXEDDUTYACCEL_REPLY_BYTES = 0,
    ROBOCLAW_READM1PID_REPLY_BYTES = 0,
    ROBOCLAW_READM2PID_REPLY_BYTES = 0,
    ROBOCLAW_SETMAINVOLTAGES_REPLY_BYTES = 0,
    ROBOCLAW_SETLOGICVOLTAGES_REPLY_BYTES = 0,
    ROBOCLAW_GETMINMAXMAINVOLTAGES_REPLY_BYTES = 0,
    ROBOCLAW_GETMINMAXLOGICVOLTAGES_REPLY_BYTES = 0,
    ROBOCLAW_SETM1POSPID_REPLY_BYTES = 0,
    ROBOCLAW_SETM2POSPID_REPLY_BYTES = 0,
    ROBOCLAW_READM1POSPID_REPLY_BYTES = 0,
    ROBOCLAW_READM2POSPID_REPLY_BYTES = 0,
    ROBOCLAW_M1SPEEDACCELDECCELPOS_REPLY_BYTES = 0,
    ROBOCLAW_M2SPEEDACCELDECCELPOS_REPLY_BYTES = 0,
    ROBOCLAW_MIXEDSPEEDACCELDECCELPOS_REPLY_BYTES = 0,
    ROBOCLAW_SETM1DEFAULTACCEL_REPLY_BYTES = 0,
    ROBOCLAW_SETM2DEFAULTACCEL_REPLY_BYTES = 0,
    ROBOCLAW_SETPINFUNCTIONS_REPLY_BYTES = 0,
    ROBOCLAW_GETPINFUNCTIONS_REPLY_BYTES = 0,
    ROBOCLAW_SETDEADBAND_REPLY_BYTES = 0,
    ROBOCLAW_GETDEADBAND_REPLY_BYTES = 0,
    ROBOCLAW_GETENCODERS_REPLY_BYTES = 10,
    ROBOCLAW_GETISPEEDS_REPLY_BYTES = 0,
    ROBOCLAW_RESTOREDEFAULTS_REPLY_BYTES = 0,
    ROBOCLAW_GETTEMP_REPLY_BYTES = 0,
    ROBOCLAW_GETTEMP2_REPLY_BYTES = 0, // Only valid on some models
    ROBOCLAW_GETERROR_REPLY_BYTES = 0,
    ROBOCLAW_GETENCODERMODE_REPLY_BYTES = 0,
    ROBOCLAW_SETM1ENCODERMODE_REPLY_BYTES = 0,
    ROBOCLAW_SETM2ENCODERMODE_REPLY_BYTES = 0,
    ROBOCLAW_WRITENVM_REPLY_BYTES = 0,
    ROBOCLAW_READNVM_REPLY_BYTES = 0, // Reloads values from Flash into Ram
    ROBOCLAW_SETCONFIG_REPLY_BYTES = 0,
    ROBOCLAW_GETCONFIG_REPLY_BYTES = 0,
    ROBOCLAW_GETSPEEDERRORS_REPLY_BYTES = 10,
    ROBOCLAW_SETM1MAXCURRENT_REPLY_BYTES = 0,
    ROBOCLAW_SETM2MAXCURRENT_REPLY_BYTES = 0,
    ROBOCLAW_GETM1MAXCURRENT_REPLY_BYTES = 0,
    ROBOCLAW_GETM2MAXCURRENT_REPLY_BYTES = 0,
    ROBOCLAW_SETPWMMODE_REPLY_BYTES = 0,
    ROBOCLAW_GETPWMMODE_REPLY_BYTES = 0,
    ROBOCLAW_FLAGBOOTLOADER_REPLY_BYTES = 0
};

enum
{
    ROBOCLAW_BUFFER_SIZE = 128
}; // has to be big enough to accomodate both command and its reply
...
static int encode_read_speed_m1(uint8_t *buffer, uint8_t address, uint16_t *cmd_crc16)
{
    uint8_t bytes = 0;
    buffer[bytes++] = address;
    buffer[bytes++] = GETM1SPEED;
    *cmd_crc16 = calculate_crc16(buffer, bytes);
    return bytes;
}

static int encode_read_speed_m2(uint8_t *buffer, uint8_t address, uint16_t *cmd_crc16)
{
    uint8_t bytes = 0;
    buffer[bytes++] = address;
    buffer[bytes++] = GETM2SPEED;
    *cmd_crc16 = calculate_crc16(buffer, bytes);
    return bytes;
}
...
static void decode_read_speed_m1(uint8_t *buffer, int32_t *speedm1)
{
    *speedm1 = decode_uint32_t(buffer);
}

static void decode_read_speed_m2(uint8_t *buffer, int32_t *speedm2)
{
    *speedm2 = decode_uint32_t(buffer);
}
...
struct roboclaw *roboclaw_init(const char *tty, int baudrate)
{
    int timeout_ms;
    if (baudrate == 2400)
        timeout_ms = ROBOCLAW_B2400_TIMEOUT_MS;
    else if (baudrate == 9600)
        timeout_ms = ROBOCLAW_B9600_TIMEOUT_MS;
    else if (baudrate == 19200)
        timeout_ms = ROBOCLAW_B19200_TIMEOUT_MS;
    else if (baudrate == 38400)
        timeout_ms = ROBOCLAW_B38400_TIMEOUT_MS;
    else if (baudrate == 57600)
        timeout_ms = ROBOCLAW_B57600_TIMEOUT_MS;
    else
        timeout_ms = ROBOCLAW_B115200_ABOVE_TIMEOUT_MS;
...
int roboclaw_main_battery_voltage(struct roboclaw *rc, uint8_t address, int16_t *voltage)
{
    ...
    if ((ret = send_cmd_wait_answer(rc, bytes, ROBOCLAW_GETMBATT_REPLY_BYTES, sent_crc16)) < 0)
...
int roboclaw_encoders(struct roboclaw *rc, uint8_t address, int32_t *enc_m1, int32_t *enc_m2)
{
    ...
    if ((ret = send_cmd_wait_answer(rc, bytes, ROBOCLAW_GETENCODERS_REPLY_BYTES, sent_crc16)) < 0)
        return ret; // IO error or retries exceeded
...
int roboclaw_read_speed_m1(struct roboclaw *rc, uint8_t address, int32_t *speed_m1)
{
    int bytes, ret;
    uint16_t sent_crc16;

    bytes = encode_read_speed_m1(rc->buffer, address, &sent_crc16);

    if ((ret = send_cmd_wait_answer(rc, bytes, ROBOCLAW_GETM1ENC_REPLY_BYTES, sent_crc16)) < 0)
        return ret; // IO error or retries exceeded
    
    decode_read_speed_m1(rc->buffer + bytes, speed_m1);

    return ROBOCLAW_OK;
}

int roboclaw_read_speed_m2(struct roboclaw *rc, uint8_t address, int32_t *speed_m2)
{
    int bytes, ret;
    uint16_t sent_crc16;

    bytes = encode_read_speed_m2(rc->buffer, address, &sent_crc16);

    if ((ret = send_cmd_wait_answer(rc, bytes, ROBOCLAW_GETM2ENC_REPLY_BYTES, sent_crc16)) < 0)
        return ret; // IO error or retries exceeded
    
    decode_read_speed_m2(rc->buffer + bytes, speed_m2);
...
int roboclaw_speed_error_m1m2(struct roboclaw *rc, uint8_t address, int32_t *enc_m1, int32_t *enc_m2)
{
    ...
    if ((ret = send_cmd_wait_answer(rc, bytes, ROBOCLAW_GETSPEEDERRORS_REPLY_BYTES, sent_crc16)) < 0)
        return ret; // IO error or retries exceeded
...
int roboclaw_currents(struct roboclaw *rc, uint8_t address, float *current_m1, float *current_m2)
{
    ...
    if ((ret = send_cmd_wait_answer(rc, bytes, ROBOCLAW_GETCURRENTS_REPLY_BYTES, sent_crc16)) < 0)
        return ret; // IO error or retries exceeded
